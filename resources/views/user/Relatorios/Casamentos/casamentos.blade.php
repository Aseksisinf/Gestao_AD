...
<script type="text/javascript" src="<?php echo asset('js/User-Relatorios-AnvCasamentos.js')?>"></script>
...
<div id="wrapper">
  ...
  <strong>Relatório - Anivesarios de casamentos!</strong>
  ...
  <table class="table" style=" text-align: center; zoom:88%;"   id="tabelaAnvCasamentos">
