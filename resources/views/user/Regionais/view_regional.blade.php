<div class="modal" tabindex="-1" role="dialog" id="dlgViewRegional" data-backdrop="static">
                        ...
                        <div class="card border">
                                <div class="card-body">
                                    <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="regional">Pastor Regional</label>
                                                <label type="text" class="form-control border border-success" id="view_pastor_regional" autocomplete="off"></label>
                                            </div>
